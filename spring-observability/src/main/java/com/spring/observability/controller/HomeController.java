...
public class HomeController {
    ...
    private WSNotificationResponse sendNotification() {
        ...
        ResponseEntity<WSNotificationResponse> responseEntity = restTemplate.exchange("http://localhost:8083/api/notification", HttpMethod.POST,entity, WSNotificationResponse.class);
//        WSNotificationResponse responseEntity=restTemplate.postForObject("http://localhost:8083/api/notification", entity, WSNotificationResponse.class);
